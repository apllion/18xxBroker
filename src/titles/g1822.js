...
export const g1822 = {
  ...defaults,
  titleId: 'g1822', title: '1822', subtitle: 'The Railways of Great Britain', designer: 'Simon Cutforth',
  ...
  currencyFormat: '£', capitalization: 'incremental', floatPercent: 20, sellBuyOrder: 'sell_buy', mustSellInBlocks: true,
  market: [
    ['','','','','','','','','','','','','','','','','','550','600','650','700e'],
  ...
  companies: [
    ...
    { sym: 'P1', name: 'BEC (5-Train)', value: 0, revenue: 5, desc: 'Comes with a 5-train.' },
    { sym: 'P5', name: 'LC&DR (English Channel)', value: 0, revenue: 10, desc: 'English Channel connection.' },
    { sym: 'P6', name: 'L&SR (Mail Contract)', value: 0, revenue: 10, desc: 'Mail contract.' },
    { sym: 'P7', name: 'S&BR (Mail Contract)', value: 0, revenue: 10, desc: 'Mail contract.' },
    { sym: 'P13', name: 'YN&BR (Pullman)', value: 0, revenue: 10, desc: 'Pullman car.' },
